...
MESSAGES = {
    "authorization_invalid": "인증 코드가 없거나 형식이 잘못되었거나 올바르지 않아 계획이 거부되었습니다. 어떤 작업도 시뮬레이션되거나 실행되지 않았습니다.",
    "web_search_unavailable": "이 House Brain 인스턴스에는 웹 검색이 설정되어 있지 않습니다.",
    "entity_ambiguous": "요청한 이름이 제어 가능한 단일 엔터티를 식별하지 못합니다. 정확한 장치 이름을 지정하세요.",
    "entity_not_found": "요청한 이름과 일치하는 엔터티를 찾지 못했습니다. 장치 이름을 확인하세요.",
    "entity_not_controllable": "요청한 엔터티가 존재하지만 제어 가능한 엔터티에 포함되어 있지 않습니다.",
    "authorization_not_validated": "제공된 코드가 작업 도구에서 검증되지 않아 계획이 거부되었습니다. 어떤 작업도 시뮬레이션되거나 실행되지 않았습니다.",
    "action_not_validated": "작업 도구가 명령을 검증하지 않아 완료할 수 없습니다. 어떤 작업도 시뮬레이션되거나 실행되지 않았습니다.",
}
