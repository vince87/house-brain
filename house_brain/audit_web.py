...
<section id="app" class="hidden"><div class="panel"><div class="toolbar"><input id="search" type="search" placeholder="__SEARCH__"><select id="mode"><option value="">__ALL__</option><option>observe</option><option>simulate</option><option>execute</option></select><button id="export">__EXPORT__</button><button id="refresh">↻</button></div><div id="status" class="status"></div></div><div id="list" class="list"></div></section>
