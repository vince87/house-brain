...
_NAVIGATION_LABELS = {
    ...
    "ko": ("채팅", "메모리", "감사", "계획", "자율성", "컨텍스트", "로그", "진단", "설치"),
    "pt": (
        "Chat",
        "Memórias",
        "Auditoria",
    ...
    "zh": ("聊天", "记忆", "审计", "计划", "自主", "上下文", "日志", "诊断", "安装"),
}
...
def shared_navigation(active: str, language: str) -> str:
    ...
    destinations = (
        ...
        ("context", "/context-views", labels[5]),
        ("logs", "/logs", labels[6]),
        ("diagnostics", "/system", labels[7]),
        ("installation", "/installation", labels[8]),
    )
    links = "".join(
